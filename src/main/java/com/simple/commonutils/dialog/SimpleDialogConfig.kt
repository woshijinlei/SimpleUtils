...
class SimpleDialogConfig(private val dialog: Dialog) {
    ...
    fun setMarginHorizontal(@Px margin: Int): SimpleDialogConfig {
        dialog.apply {
            val point = Point()
    ...
    fun setCorner(
        ...
        dialog.apply {
            this.window?.decorView!!.apply {
                val s = ShapeAppearanceModel.Builder()
                    .setTopLeftCornerSize(cornerLeft)
                    .setTopRightCornerSize(cornerTop)
                    .setBottomLeftCornerSize(cornerRight)
                    .setBottomRightCornerSize(cornerBottom)
                    .build()
